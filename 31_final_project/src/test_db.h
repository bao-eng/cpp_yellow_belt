...
void TestsMyCustom()
{
...

    {
        ...
        event ev1={{2019, 12, 3}, "f"};
        AssertEqual(ev1, db.Last({2019, 12, 4}), " My test 6");
        ...
        event ev2={{2019, 12, 2}, "c c"};
        AssertEqual(ev2, db.Last({2019, 12, 2}), " My test 7");
        event ev3={{2019, 12, 3}, "f"};
        AssertEqual(ev3, db.Last({2019, 12, 4}), " My test 8");
        
        db.Add({2019, 12, 3}, "m");
        event ev4={{2019, 12, 3}, "m"};
        AssertEqual(ev4, db.Last({2019, 12, 3}), " My test 9");
...

    {
        ...
        db.Add({2019, 12, 1}, "c");
        event ev5={{2019, 12, 1}, "c"};
        AssertEqual(ev5, db.Last({2019, 12, 1}), " My test 20");

        db.Add({2019, 12, 1}, "b");
        event ev6={{2019, 12, 1}, "c"};
        AssertEqual(ev6, db.Last({2019, 12, 1}), " My test 21");
...
void TestDatabase() {
  ...
  // Last
  {
    ...
    db.Add(d1, "e1");
    db.Add(d2, "e2");
    event ev7={{2018, 12, 22}, "e2"};
    AssertEqual(db.Last(d), ev7, "Db Last 1");
    Date d3(2018, 12, 24);
    db.Add(d3, "e3");
    event ev8={{2018, 12, 24}, "e3"};
    AssertEqual(db.Last(d), ev8, "Db Last 2");
    ...
    event ev9={{2018, 12, 22}, "e2"};
    AssertEqual(db.Last(d), ev9, "Db Last 4");
    event ev10={{2019, 1, 2}, "e1"};
    AssertEqual(db.Last(d1), ev10, "Db Last 5");
    db.Add(d2, "e4");
    event ev11={{2018, 12, 22}, "e4"};
    AssertEqual(db.Last(d2), ev11, "Db Last 6");
  }
